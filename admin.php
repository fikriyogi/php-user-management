				...
				<div class="card">
					<div class="card-header">
						...
						<h6 class="card-subtitle text-muted">
							<a href="user-add.php" class="btn btn-primary">Tambah</a> This extension provides a framework with common options that can be used with DataTables.</h6>
					</div>
					<div class="card-body">
						<table id="datatables-buttons" class="table table-striped" style="width:100%">
							...
							<tr id="<?= $row['id']; ?>">
								<td>
									<a href="php/cetak/cetak-kartu-identitas-user.php?id=<?= $row['id']?>">
										<?= $row['username']?>
									</a>
								</td>
